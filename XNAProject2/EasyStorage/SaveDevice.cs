...
namespace EasyStorage
{
    ...
    ///     SaveDeviceAsync.cs.
    /// </remarks>
    public abstract partial class SaveDevice : IGameComponent, IUpdateable, IAsyncSaveDevice
    {
        ...
        {
            get => forceCancelledReselectionMessage;
            set
            {
                if (!string.IsNullOrEmpty(value))
        ...
        {
            get => promptForDisconnectedMessage;
            set
            {
                if (!string.IsNullOrEmpty(value))
        ...
        {
            get => forceDisconnectedReselectionMessage;
            set
            {
                if (!string.IsNullOrEmpty(value))
    ...
    // make sure gamer services are available for all of our Guide methods we use			
            ...
            var deviceIsConnected = storageDevice != null && storageDevice.IsConnected;
