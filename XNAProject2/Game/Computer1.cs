...
{
    internal class Computer1
    {
        public static bool Executed;

        public static void GépJáték1()
        {
            if (Executed) return;
            Executed = true;
            ...
            int calculatork;
            for (n = 1; n <= i; n++)
                if (Main.KöverkezőLap(Main.Player2CardId[n]))
                    lehetSegesKartyak++;

            if (lehetSegesKartyak == 0) return;
            for (n = 1; n <= i; n++)
                switch (Main.Player2CardId[n])
                {
                    case 1:
                    case 2:
                    case 3:
            ...
            for (n = 1; n <= i; n++)
                if (Main.KöverkezőLap(Main.Player2CardId[n]))
                    switch (Main.Player2CardId[n])
                    {
                        ...
                        case 7:
                        case 8:
                            jelöltPiros = Main.Player2CardId[n];
                            break;
                        case 9:
                        case 10:
                        case 11:
                        ...
                        case 15:
                        case 16:
                            jelöltZöld = Main.Player2CardId[n];
                            break;
                        case 17:
                        case 18:
                        case 19:
                        ...
                        case 23:
                        case 24:
                            jelöltMakk = Main.Player2CardId[n];
                            break;
                        case 25:
                        case 26:
                        case 27:
                        ...
                        case 31:
                        case 32:
                            jelöltTök = Main.Player2CardId[n];
                            break;
                    }
            ...
            if ((Main.Piros == 0) & (Main.Zöld == 0) & (Main.Makk == 0) & (Main.Tök == 0))
            {
                ...
                calculatork = ComputerAI.Kezdés(pirosak, zöldek, makkok, tökök, jelöltPiros, jelöltZöld,
                    jelöltMakk, jelöltTök, Main.Player2CardId[1], Main.Player2CardId[2], Main.Player2CardId[3],
                    Main.Player2CardId[4], Main.Player2CardId[5], Main.Player2CardId[6], Main.Player2CardId[7],
                    Main.Player2CardId[8], 2);
                GameTable.Játékos2KártyákSzáma--;
                ...
                for (n = 1; n <= i; n++)
                    if (Main.Player2CardId[n] == calculatork)
                        Main.Player2CardId[n] = 0;

                return; // Kézdés 2 Gép VÉGE
            }

            ComputerAI.DetectLorum(pirosak, zöldek, makkok, tökök, Main.Player2CardId[1], Main.Player2CardId[2],
                Main.Player2CardId[3], Main.Player2CardId[4], Main.Player2CardId[5], Main.Player2CardId[6],
                Main.Player2CardId[7], Main.Player2CardId[8], 2);
            calculatork = ComputerAI.Játék(pirosak, zöldek, makkok, tökök, jelöltPiros, jelöltZöld, jelöltMakk,
                jelöltTök, Main.Player2CardId[1], Main.Player2CardId[2], Main.Player2CardId[3], Main.Player2CardId[4],
                Main.Player2CardId[5], Main.Player2CardId[6], Main.Player2CardId[7], Main.Player2CardId[8], 2);
            GameTable.Játékos2KártyákSzáma--;
            switch (calculatork)
            {
                case 1:
                ...
                case 7:
                case 8:
                    if (GameTable.Játékos2KártyákSzáma == 0) Main.Player2Win();
                    Main.LórumPiros = false;
                    Main.Piros = calculatork;
                    Main.kitettPiros++;
                    Main.card[8].Active = true;
